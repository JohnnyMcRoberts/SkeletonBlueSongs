namespace SongsFileImportExport.Test.Parser
{
    ...
    [TestClass]
    public class SongFileParserCsvTest
    {
        #region Constants
        ...
        public void TestInvalidFile()
        {
            ...
            var albums = SongFileParserCsv.GetAlbumsPlayedFromFile(invalidFile);
        ...
        public void TestValidFile_TestFileNameSingleDay()
        {
            ...
            string singleDayPath = PathUtilities.GetPathToFile(PathUtilities.TestFileNameSingleDayCsv);
            Assert.IsTrue(File.Exists(singleDayPath));

            // Get the albums
            List<AlbumPlayed> albums = SongFileParserCsv.GetAlbumsPlayedFromFile(singleDayPath);
            Assert.IsNotNull(albums);
        ...
        [TestMethod]
        public void TestValidFile_TestFileNameAllDaysCsv()
        {
            // Check the file is OK
            string singleDayPath = PathUtilities.GetPathToFile(PathUtilities.TestFileNameAllDaysCsv);
            Assert.IsTrue(File.Exists(singleDayPath));
        ...
        public SongFileParserCsvTest()
        {
            TestFilePathAllDays = PathUtilities.GetPathToFile(PathUtilities.TestFileNameAllDaysCsv);
        }
